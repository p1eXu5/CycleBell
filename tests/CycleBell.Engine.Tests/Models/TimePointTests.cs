...
namespace CycleBell.Engine.Tests.Models
{
    ...
    public class TimePointTests
    {
        ...
        public void ctor_ByDefault_CreatsRelativeTimePoint()
        {
            ...
            Assert.IsTrue (timePoint.Kind == TimePointKinds.Relative);
        }
        ...
        {
            var timePoint = new TimePoint("0:00:00");

            Assert.That(timePoint.Name, Is.EqualTo(TimePoint.GetDefaultName(timePoint)));
        }
        ...
        public void GetAbsoluteTime_ByDefaultRelativeTimePointBaseTimeNotSet_Throws()
        {
            ...
            var ex = Assert.Catch< BaseTimeNotSettedException >(() => timePoint.GetAbsoluteTime());

            StringAssert.Contains("Base time is not setted ", ex.Message);
        }
        ...
        public void Clone_WhenCalled_GetsClone()
        {
            ...
            Assert.AreEqual(timePoint.Kind, timePointClone.Kind);
        ...
        {
            var tp = new TimePoint("Test TimePoint", "0:00:00");
            tp.ChangeTimePointType (TimePointKinds.Relative);
